...
<template>
  <div>
    ...
    <div id="myExam">
      ...
      <div class="wrapper">
        <el-button type="warning" class="ui-button" plain @click="toViews()"
          >立即培训</el-button
        >
        <ul class="top">
        ...
        <ul class="paper" v-loading="listLoading">
          ...
          >
            ...
            <strong
              ><p class="name">{{ item.shiftName }}</p></strong
            >
            <div class="info">
              <span
                >专业分类：{{ item.professName1 }} /
                {{ item.professName2 }}</span
              >
            </div>
            <div class="info">
              <span
                >考试时间：{{ item.startTime | dateFormat }} 至
                {{ item.endTime | dateFormat }}</span
              >
            </div>
            <div class="info">
              <i class="el-icon-loading"></i>
              <i class="iconfont icon-icon-time"></i
              ><span v-if="item.totalTime != null" style="display:inline-block"
