...
<template>
  <div id="answer">
    ...
    <div class="top">
      <ul class="item">
        <li><i ref="toggle" class="iconfont icon-menufold icon20" @click="slider_flag = !slider_flag" /></li>
        <li>欢迎admin参加 {{ examData.name }} 考试</li>
        <!--         <li @click="flag = !flag">
        ...
        <li><i class="iconfont icon-arrLeft icon20" /></li>
      </ul>
    </div>
    <div class="flexarea">
      <!--左边题目编号区-->
              ...
              <div class="item">
                ...
                <ul>
                  <li v-for="(item, index1) in topic[0]" :key="index1">
                    <a href="javascript:;" :class="{'border': index == index1 && currentType == 0,'bg': fillAnswer[index1][3] != 0}" @click="fill(index1)"><span :class="{'mark': topic[0][index1].isMark == true}" />{{ index1+1 }}</a>
                  </li>
                </ul>
              </div>
            </template>
              ...
              <div class="item">
                ...
                <ul>
                  <li v-for="(list, index2) in topic[1]" :key="index2">
                    <a href="javascript:;" :class="{'border': index == index2 && currentType == 1,'bg': bg_flag && topic[1][index2].isClick == true}" @click="judge(index2)"><span :class="{'mark': topic[1][index2].isMark == true}" />{{ topicCount[0]+index2+1 }}</a>
                  </li>
                </ul>
              </div>
            </template>
                ...
                <ul>
                  <li v-for="(list, index3) in topic[2]" :key="index3">
                    <a
                      ...
                      @click="change(index3)"
                    >
                      <span :class="{'mark': topic[2][index3].isMark == true}" />
              ...
              <div class="item">
                ...
                <ul>
                  <li v-for="(list, index4) in topic[3]" :key="index4">
                    ...
                    >
                      <span :class="{'mark': topic[3][index4].isMark == true}" />
      ...
      <transition name="slider-fade">
        <div class="right">
          <div class="title">
            ...
            <span>全卷共{{ topicCount[0] + topicCount[1] + topicCount[2] }}题  <i class="iconfont icon-time" />倒计时：<b>{{ time }}</b>分钟</span>
          </div>
          <div class="content">
          ...
          <div class="operation">
            <ul class="end">
              <li @click="previous()"><i class="iconfont icon-previous" /><span>上一题</span></li>
              <li @click="mark()"><i class="iconfont icon-mark-o" /><span>标记</span></li>
              <li @click="next()"><span>下一题</span><i class="iconfont icon-next" /></li>
            </ul>
          </div>
        </div>
      </transition>
