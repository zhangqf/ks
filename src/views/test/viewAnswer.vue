  ...
  <div id="answer">
    ...
    <div class="top">
      <ul class="item">
        ...
        <li>欢迎{{ currentUser }}参加 {{ examData.name }} 考试</li>
        <!--         <li @click="flag = !flag">
        ...
        <transition name="slider-fade">
          <div v-if="slider_flag" class="left">
            ...
            <div class="l-bottom">
              ...
              <div v-else class="final" @click="commit()">结束考试</div>
            </div>
          </div>
        </transition>
      </div>
...
export default {
  ...
  methods: {
    ...
    getViewData() {
      console.log(123)
      const recordId = this.recordid // 考试记录id
      const params = {
        recordId: recordId
      }
      // 查询试卷的详细信息
      viewExamRecord(params).then(response => {
        ...
        if (response.data.code === 200) {
          ...
          console.log('-------')
          console.log(response.data.data.questionMap)
          this.topic = dataMap
