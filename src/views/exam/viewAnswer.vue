...
<template>
  <div id="answer">
    ...
    <div v-if="state!=null" class="ui-videos">
      <video-player
        ref="videoPlayer"
    ...
    <div class="flexarea" :class="state==null?'paperOnelyClass':''">
      <!--左边题目编号区-->
                ...
                <div v-if="isPractice" class="analysis">
                  <ul>
                    <li v-if="singleList[index]">
                      <el-tag type="success">你的答案：</el-tag><span class="right">{{
                        singleList[index] == "?" ? "未作答" : singleList[index]
                      }}</span>
                    </li>
                    <li>
                      <el-tag type="success">正确答案：</el-tag><span class="right">{{
      ...
      <transition name="slider-fade">
        <div v-if="slider_flag" class="left">
          ...
          <div class="l-bottom">
            ...
            <div v-if="isPractice" class="final" @click="close()">返回</div>
...
export default {
  ...
  methods: {
    ...
    playerStateChanged(e) {
      ...
      // if(e.timeupdate>=4.8&&e.timeupdate<=5){
      //
      //   this. $refs. videoPlayer. player. pause()
      //   this.isShow=true
      // }
      // if(e.timeupdate>=13&&e.timeupdate<=13.3){
      //   // this.onPlayerPause()
      //
      //   this. $refs. videoPlayer. player. pause()
      //
    ...
    getViewData() {
      ...
      viewExamRecord(params).then(response => {
        if (response.data.code === 200) {
          ...
          this.playerOptions.sources[0].src = `${process.env.VUE_APP_BASE_API}${
            this.examData.videopath
          }`
          ...
          for (let i = 0; i < len; i++) {
            ...
            if (this.fillList[i] != '?' && this.fillList[i] != undefined) {
              console.log(this.fillList[i] + 'www')
